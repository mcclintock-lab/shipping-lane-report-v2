...
ShippingLaneReportTab = (function(_super) {
  ...
  ShippingLaneReportTab.prototype.render = function() {
    ...
    for (_j = 0, _len1 = sightingsData.length; _j < _len1; _j++) {
      ...
      if (_.isNaN(record.percentChange) || record.percentChange === 0.0) {
